...
const GetHired = () => {
  return (
    ...
    >
      ...
      <div className="mx-auto mt-15 min-h-[1100px] w-[100%] md:min-h-[1700px] md:w-[750px] lg:min-h-[730px] lg:w-[980px]">
        <iframe
          src="https://cal.com/stelllar.vision/30min?layout=month_view"
          className="mx-auto h-full min-h-[1100px] w-[100%] border-none md:min-h-[1700px] md:w-[750px] lg:min-h-[730px] lg:w-[980px]"
          allowFullScreen
